...
export default function Base(){
  ...
  useEffect(() => {
    ...
    const uniforms = {
      mainTex: { value: new THREE.TextureLoader().load('/texture/bump/bricks2.jpg') },
      depthMap: { value: new THREE.TextureLoader().load('/texture/bump/bricks2_disp.jpg') },
      threshold: { value: params.progress},
      lightDirection: { value: new THREE.Vector3(1, 1, 1).normalize() }, // 主光照方向
      ambientLight: { value: new THREE.Color(0x303030) }, // 环境光
      lightColor: { value: new THREE.Color(0xffffff) }, // 光源颜色
  };
